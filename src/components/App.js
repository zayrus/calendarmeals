    ...
    return (
      <div className='container'>
        ...
        <div className="calendar">
          ...
          <div className="days">
            {calendar.map(({ day, index}) => <h3 key={day + index} className='subheader'>{capitalize(day)}</h3>)}
          </div>
          <div className="icon-grid">
            { calendar.map(({ day, meals, index }) => (
              <ul key={day}>
                {mealOrder.map((meal) => (
                  <li key={meal + index} className='meal'>
                    {meals[meal]
